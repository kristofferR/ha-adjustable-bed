...
_SCHEMA: dict[str, object] = {
    ...
    "$defs": {
        ...
        "attested_root_evidence_member": {
            "type": "object",
            "required": ["member", "member_sha256", "evidence_anchor_ids"],
            "properties": {
                "member": {"type": "string", "minLength": 1, "maxLength": 4096},
        ...
        "attested_root_evidence": {
            ...
            "properties": {
                "target_root_id": {"$ref": "#/$defs/sha256"},
                "target_occurrence_identity_sha256": {"$ref": "#/$defs/sha256"},
                "semantic_root_sha256": {"$ref": "#/$defs/sha256"},
                "evidence_members": {
                    "type": "array",
                    "minItems": 1,
                    "maxItems": 4096,
                    "items": {"$ref": "#/$defs/attested_root_evidence_member"},
                },
            },
            "additionalProperties": False,
        },
        "attested_evidence_anchor": {
            ...
            "properties": {
                ...
                "representation": {"enum": ["hex", "json-scalar", "utf8"]},
