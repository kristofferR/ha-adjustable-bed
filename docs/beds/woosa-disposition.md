...
| W13 | Brightness levels 0–10, separate Off and on timers 10/480/600 minutes | IMPLEMENTED | `WoosaController.lights_on`, `lights_off`, `set_light_timer`, inherited `set_light_level`, light/number/select entities and command/state tests. Requested state is optimistic. |
