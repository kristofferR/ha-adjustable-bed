...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ae=/'/g,Se=/"/g,Me=/^(?:script|style|textarea|title)$/i,ce=o=>(s,...e)=>({_$litType$:o,strings:s,values:e}),p=ce(1),Te=ce(2),vt=ce(3),k=Symbol.for("lit-noChange"),c=Symbol.for("lit-nothing"),ke=new WeakMap,A=S.createTreeWalker(S,129);function Pe(o,s){if(!ae(o)||!o.hasOwnProperty("raw"))throw Error("invalid template strings array");return xe!==void 0?xe.createHTML(s):s}var Qe=(o,s)=>{let e=o.length-1,t=[],i,r=s===2?"<svg>":s===3?"<math>":"",n=U;for(let a=0;a<e;a++){let l=o[a],m,f,d=-1,h=0;for(;h<l.length&&(n.lastIndex=h,f=n.exec(l),f!==null);)h=n.lastIndex,n===U?f[1]==="!--"?n=we:f[1]!==void 0?n=Ee:f[2]!==void 0?(Me.test(f[2])&&(i=RegExp("</"+f[2],"g")),n=E):f[3]!==void 0&&(n=E):n===E?f[0]===">"?(n=i??U,d=-1):f[1]===void 0?d=-2:(d=n.lastIndex-f[2].length,m=f[1],n=f[3]===void 0?E:f[3]==='"'?Se:Ae):n===Se||n===Ae?n=E:n===we||n===Ee?n=U:(n=E,i=void 0);let _=n===E&&o[a+1].startsWith("/>")?" ":"";r+=n===U?l+Xe:d>=0?(t.push(m),l.slice(0,d)+Re+l.slice(d)+$+_):l+$+(d===-2?a:_)}return[Pe(o,r+(o[e]||"<?>")+(s===2?"</svg>":s===3?"</math>":"")),t]},I=class o{constructor({strings:s,_$litType$:e},t){let i;this.parts=[];let r=0,n=0,a=s.length-1,l=this.parts,[m,f]=Qe(s,e);if(this.el=o.createElement(m,t),A.currentNode=this.el.content,e===2||e===3){let d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(i=A.nextNode())!==null&&l.length<a;){if(i.nodeType===1){if(i.hasAttributes())for(let d of i.getAttributeNames())if(d.endsWith(Re)){let h=f[n++],_=i.getAttribute(d).split($),g=/([.?@])?(.*)/.exec(h);l.push({type:1,index:r,name:g[2],strings:_,ctor:g[1]==="."?se:g[1]==="?"?ie:g[1]==="@"?oe:T}),i.removeAttribute(d)}else d.startsWith($)&&(l.push({type:6,index:r}),i.removeAttribute(d));if(Me.test(i.tagName)){let d=i.textContent.split($),h=d.length-1;if(h>0){i.textContent=J?J.emptyScript:"";for(let _=0;_<h;_++)i.append(d[_],D()),A.nextNode(),l.push({type:2,index:++r});i.append(d[h],D())}}}else if(i.nodeType===8)if(i.data===Ce)l.push({type:2,index:r});else{let d=-1;for(;(d=i.data.indexOf($,d+1))!==-1;)l.push({type:7,index:r}),d+=$.length-1}r++}}static createElement(s,e){let t=S.createElement("template");return t.innerHTML=s,t}};function M(o,s,e=o,t){if(s===k)return s;let i=t!==void 0?e._$Co?.[t]:e._$Cl,r=z(s)?void 0:s._$litDirective$;return i?.constructor!==r&&(i?._$AO?.(!1),r===void 0?i=void 0:(i=new r(o),i._$AT(o,e,t)),t!==void 0?(e._$Co??=[])[t]=i:e._$Cl=i),i!==void 0&&(s=M(o,i._$AS(o,s.values),i,t)),s}var te=class{constructor(s,e){this._$AV=[],this._$AN=void 0,this._$AD=s,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(s){let{el:{content:e},parts:t}=this._$AD,i=(s?.creationScope??S).importNode(e,!0);A.currentNode=i;let r=A.nextNode(),n=0,a=0,l=t[0];for(;l!==void 0;){if(n===l.index){let m;l.type===2?m=new F(r,r.nextSibling,this,s):l.type===1?m=new l.ctor(r,l.name,l.strings,this,s):l.type===6&&(m=new re(r,this,s)),this._$AV.push(m),l=t[++a]}n!==l?.index&&(r=A.nextNode(),n++)}return A.currentNode=S,i}p(s){let e=0;for(let t of this._$AV)t!==void 0&&(t.strings!==void 0?(t._$AI(s,t,e),e+=t.strings.length-2):t._$AI(s[e])),e++}},F=class o{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(s,e,t,i){this.type=2,this._$AH=c,this._$AN=void 0,this._$AA=s,this._$AB=e,this._$AM=t,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let s=this._$AA.parentNode,e=this._$AM;return e!==void 0&&s?.nodeType===11&&(s=e.parentNode),s}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(s,e=this){s=M(this,s,e),z(s)?s===c||s==null||s===""?(this._$AH!==c&&this._$AR(),this._$AH=c):s!==this._$AH&&s!==k&&this._(s):s._$litType$!==void 0?this.$(s):s.nodeType!==void 0?this.T(s):Ze(s)?this.k(s):this._(s)}O(s){return this._$AA.parentNode.insertBefore(s,this._$AB)}T(s){this._$AH!==s&&(this._$AR(),this._$AH=this.O(s))}_(s){this._$AH!==c&&z(this._$AH)?this._$AA.nextSibling.data=s:this.T(S.createTextNode(s)),this._$AH=s}$(s){let{values:e,_$litType$:t}=s,i=typeof t=="number"?this._$AC(s):(t.el===void 0&&(t.el=I.createElement(Pe(t.h,t.h[0]),this.options)),t);if(this._$AH?._$AD===i)this._$AH.p(e);else{let r=new te(i,this),n=r.u(this.options);r.p(e),this.T(n),this._$AH=r}}_$AC(s){let e=ke.get(s.strings);return e===void 0&&ke.set(s.strings,e=new I(s)),e}k(s){ae(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,t,i=0;for(let r of s)i===e.length?e.push(t=new o(this.O(D()),this.O(D()),this,this.options)):t=e[i],t._$AI(r),i++;i<e.length&&(this._$AR(t&&t._$AB.nextSibling,i),e.length=i)}_$AR(s=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);s!==this._$AB;){let t=$e(s).nextSibling;$e(s).remove(),s=t}}setConnected(s){this._$AM===void 0&&(this._$Cv=s,this._$AP?.(s))}},T=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(s,e,t,i,r){this.type=1,this._$AH=c,this._$AN=void 0,this.element=s,this.name=e,this._$AM=i,this.options=r,t.length>2||t[0]!==""||t[1]!==""?(this._$AH=Array(t.length-1).fill(new String),this.strings=t):this._$AH=c}_$AI(s,e=this,t,i){let r=this.strings,n=!1;if(r===void 0)s=M(this,s,e,0),n=!z(s)||s!==this._$AH&&s!==k,n&&(this._$AH=s);else{let a=s,l,m;for(s=r[0],l=0;l<r.length-1;l++)m=M(this,a[t+l],e,l),m===k&&(m=this._$AH[l]),n||=!z(m)||m!==this._$AH[l],m===c?s=c:s!==c&&(s+=(m??"")+r[l+1]),this._$AH[l]=m}n&&!i&&this.j(s)}j(s){s===c?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,s??"")}},se=class extends T{constructor(){super(...arguments),this.type=3}j(s){this.element[this.name]=s===c?void 0:s}},ie=class extends T{constructor(){super(...arguments),this.type=4}j(s){this.element.toggleAttribute(this.name,!!s&&s!==c)}},oe=class extends T{constructor(s,e,t,i,r){super(s,e,t,i,r),this.type=5}_$AI(s,e=this){if((s=M(this,s,e,0)??c)===k)return;let t=this._$AH,i=s===c&&t!==c||s.capture!==t.capture||s.once!==t.once||s.passive!==t.passive,r=s!==c&&(t===c||i);i&&this.element.removeEventListener(this.name,this,t),r&&this.element.addEventListener(this.name,this,s),this._$AH=s}handleEvent(s){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,s):this._$AH.handleEvent(s)}},re=class{constructor(s,e,t){this.element=s,this.type=6,this._$AN=void 0,this._$AM=e,this.options=t}get _$AU(){return this._$AM._$AU}_$AI(s){M(this,s)}};var Ye=ne.litHtmlPolyfillSupport;Ye?.(I,F),(ne.litHtmlVersions??=[]).push("3.3.3");var Oe=(o,s,e)=>{let t=e?.renderBefore??s,i=t._$litPart$;if(i===void 0){let r=e?.renderBefore??null;t._$litPart$=i=new F(s.insertBefore(D(),r),r,void 0,e??{})}return i._$AI(o),i};var le=globalThis,v=class extends b{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let s=super.createRenderRoot();return this.renderOptions.renderBefore??=s.firstChild,s}update(s){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(s),this._$Do=Oe(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return k}};v._$litElement$=!0,v.finalized=!0,le.litElementHydrateSupport?.({LitElement:v});var et=le.litElementPolyfillSupport;et?.({LitElement:v});(le.litElementVersions??=[]).push("4.2.2");var X=o=>(s,e)=>{e!==void 0?e.addInitializer(()=>{customElements.define(o,s)}):customElements.define(o,s)};var tt={attribute:!0,type:String,converter:L,reflect:!1,hasChanged:G},st=(o=tt,s,e)=>{let{kind:t,metadata:i}=e,r=globalThis.litPropertyMetadata.get(i);if(r===void 0&&globalThis.litPropertyMetadata.set(i,r=new Map),t==="setter"&&((o=Object.create(o)).wrapped=!0),r.set(e.name,o),t==="accessor"){let{name:n}=e;return{set(a){let l=s.get.call(this);s.set.call(this,a),this.requestUpdate(n,l,o,!0,a)},init(a){return a!==void 0&&this.C(n,void 0,o,a),a}}}if(t==="setter"){let{name:n}=e;return function(a){let l=this[n];s.call(this,a),this.requestUpdate(n,l,o,!0,a)}}throw Error("Unsupported decorator location: "+t)};function P(o){return(s,e)=>typeof e=="object"?st(o,s,e):((t,i,r)=>{let n=i.hasOwnProperty(r);return i.constructor.createProperty(r,t),n?Object.getOwnPropertyDescriptor(i,r):void 0})(o,s,e)}function q(o){return P({...o,state:!0,attribute:!1})}var de=o=>Math.max(0,Math.min(75,o));function He(o){let s=de(o.upper.angle??0),e=de(o.lower.angle??0),t=`rotate(${s} 150 70)`,i=`rotate(${-e} 150 70)`,r=n=>n.angle===void 0?"":`${n.label?`${n.label} `:""}${Math.round(de(n.angle))}\xB0`;return Te`
    <svg
