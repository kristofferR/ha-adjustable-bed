/* adjustable-bed-card 3.0.0 — ships with the Adjustable Bed integration. Do not edit; build from frontend/src. */
var De=Object.defineProperty;var ze=Object.getOwnPropertyDescriptor;var y=(o,s,e,t)=>{for(var i=t>1?void 0:t?ze(s,e):s,r=o.length-1,n;r>=0;r--)(n=o[r])&&(i=(t?n(s,e,i):n(i))||i);return t&&i&&De(s,e,i),i};var W=globalThis,V=W.ShadowRoot&&(W.ShadyCSS===void 0||W.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Y=Symbol(),fe=new WeakMap,B=class{constructor(s,e,t){if(this._$cssResult$=!0,t!==Y)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=s,this.t=e}get styleSheet(){let s=this.o,e=this.t;if(V&&s===void 0){let t=e!==void 0&&e.length===1;t&&(s=fe.get(e)),s===void 0&&((this.o=s=new CSSStyleSheet).replaceSync(this.cssText),t&&fe.set(e,s))}return s}toString(){return this.cssText}},_e=o=>new B(typeof o=="string"?o:o+"",void 0,Y),N=(o,...s)=>{let e=o.length===1?o[0]:s.reduce((t,i,r)=>t+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+o[r+1],o[0]);return new B(e,o,Y)},ve=(o,s)=>{if(V)o.adoptedStyleSheets=s.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(let e of s){let t=document.createElement("style"),i=W.litNonce;i!==void 0&&t.setAttribute("nonce",i),t.textContent=e.cssText,o.appendChild(t)}},ee=V?o=>o:o=>o instanceof CSSStyleSheet?(s=>{let e="";for(let t of s.cssRules)e+=t.cssText;return _e(e)})(o):o;var{is:Ie,defineProperty:Fe,getOwnPropertyDescriptor:qe,getOwnPropertyNames:Ke,getOwnPropertySymbols:We,getPrototypeOf:Ve}=Object,G=globalThis,ye=G.trustedTypes,Ge=ye?ye.emptyScript:"",Je=G.reactiveElementPolyfillSupport,j=(o,s)=>o,L={toAttribute(o,s){switch(s){case Boolean:o=o?Ge:null;break;case Object:case Array:o=o==null?o:JSON.stringify(o)}return o},fromAttribute(o,s){let e=o;switch(s){case Boolean:e=o!==null;break;case Number:e=o===null?null:Number(o);break;case Object:case Array:try{e=JSON.parse(o)}catch{e=null}}return e}},J=(o,s)=>!Ie(o,s),be={attribute:!0,type:String,converter:L,reflect:!1,useDefault:!1,hasChanged:J};Symbol.metadata??=Symbol("metadata"),G.litPropertyMetadata??=new WeakMap;var b=class extends HTMLElement{static addInitializer(s){this._$Ei(),(this.l??=[]).push(s)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(s,e=be){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(s)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(s,e),!e.noAccessor){let t=Symbol(),i=this.getPropertyDescriptor(s,t,e);i!==void 0&&Fe(this.prototype,s,i)}}static getPropertyDescriptor(s,e,t){let{get:i,set:r}=qe(this.prototype,s)??{get(){return this[e]},set(n){this[e]=n}};return{get:i,set(n){let a=i?.call(this);r?.call(this,n),this.requestUpdate(s,a,t)},configurable:!0,enumerable:!0}}static getPropertyOptions(s){return this.elementProperties.get(s)??be}static _$Ei(){if(this.hasOwnProperty(j("elementProperties")))return;let s=Ve(this);s.finalize(),s.l!==void 0&&(this.l=[...s.l]),this.elementProperties=new Map(s.elementProperties)}static finalize(){if(this.hasOwnProperty(j("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(j("properties"))){let e=this.properties,t=[...Ke(e),...We(e)];for(let i of t)this.createProperty(i,e[i])}let s=this[Symbol.metadata];if(s!==null){let e=litPropertyMetadata.get(s);if(e!==void 0)for(let[t,i]of e)this.elementProperties.set(t,i)}this._$Eh=new Map;for(let[e,t]of this.elementProperties){let i=this._$Eu(e,t);i!==void 0&&this._$Eh.set(i,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(s){let e=[];if(Array.isArray(s)){let t=new Set(s.flat(1/0).reverse());for(let i of t)e.unshift(ee(i))}else s!==void 0&&e.push(ee(s));return e}static _$Eu(s,e){let t=e.attribute;return t===!1?void 0:typeof t=="string"?t:typeof s=="string"?s.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(s=>this.enableUpdating=s),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(s=>s(this))}addController(s){(this._$EO??=new Set).add(s),this.renderRoot!==void 0&&this.isConnected&&s.hostConnected?.()}removeController(s){this._$EO?.delete(s)}_$E_(){let s=new Map,e=this.constructor.elementProperties;for(let t of e.keys())this.hasOwnProperty(t)&&(s.set(t,this[t]),delete this[t]);s.size>0&&(this._$Ep=s)}createRenderRoot(){let s=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ve(s,this.constructor.elementStyles),s}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(s=>s.hostConnected?.())}enableUpdating(s){}disconnectedCallback(){this._$EO?.forEach(s=>s.hostDisconnected?.())}attributeChangedCallback(s,e,t){this._$AK(s,t)}_$ET(s,e){let t=this.constructor.elementProperties.get(s),i=this.constructor._$Eu(s,t);if(i!==void 0&&t.reflect===!0){let r=(t.converter?.toAttribute!==void 0?t.converter:L).toAttribute(e,t.type);this._$Em=s,r==null?this.removeAttribute(i):this.setAttribute(i,r),this._$Em=null}}_$AK(s,e){let t=this.constructor,i=t._$Eh.get(s);if(i!==void 0&&this._$Em!==i){let r=t.getPropertyOptions(i),n=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:L;this._$Em=i;let a=n.fromAttribute(e,r.type);this[i]=a??this._$Ej?.get(i)??a,this._$Em=null}}requestUpdate(s,e,t,i=!1,r){if(s!==void 0){let n=this.constructor;if(i===!1&&(r=this[s]),t??=n.getPropertyOptions(s),!((t.hasChanged??J)(r,e)||t.useDefault&&t.reflect&&r===this._$Ej?.get(s)&&!this.hasAttribute(n._$Eu(s,t))))return;this.C(s,e,t)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(s,e,{useDefault:t,reflect:i,wrapped:r},n){t&&!(this._$Ej??=new Map).has(s)&&(this._$Ej.set(s,n??e??this[s]),r!==!0||n!==void 0)||(this._$AL.has(s)||(this.hasUpdated||t||(e=void 0),this._$AL.set(s,e)),i===!0&&this._$Em!==s&&(this._$Eq??=new Set).add(s))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}let s=this.scheduleUpdate();return s!=null&&await s,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[i,r]of this._$Ep)this[i]=r;this._$Ep=void 0}let t=this.constructor.elementProperties;if(t.size>0)for(let[i,r]of t){let{wrapped:n}=r,a=this[i];n!==!0||this._$AL.has(i)||a===void 0||this.C(i,void 0,r,a)}}let s=!1,e=this._$AL;try{s=this.shouldUpdate(e),s?(this.willUpdate(e),this._$EO?.forEach(t=>t.hostUpdate?.()),this.update(e)):this._$EM()}catch(t){throw s=!1,this._$EM(),t}s&&this._$AE(e)}willUpdate(s){}_$AE(s){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(s)),this.updated(s)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(s){return!0}update(s){this._$Eq&&=this._$Eq.forEach(e=>this._$ET(e,this[e])),this._$EM()}updated(s){}firstUpdated(s){}};b.elementStyles=[],b.shadowRootOptions={mode:"open"},b[j("elementProperties")]=new Map,b[j("finalized")]=new Map,Je?.({ReactiveElement:b}),(G.reactiveElementVersions??=[]).push("2.1.2");var ae=globalThis,$e=o=>o,X=ae.trustedTypes,xe=X?X.createPolicy("lit-html",{createHTML:o=>o}):void 0,Re="$lit$",$=`lit$${Math.random().toFixed(9).slice(2)}$`,Ce="?"+$,Xe=`<${Ce}>`,S=document,D=()=>S.createComment(""),z=o=>o===null||typeof o!="object"&&typeof o!="function",ce=Array.isArray,Ze=o=>ce(o)||typeof o?.[Symbol.iterator]=="function",te=`[ 	
\f\r]`,U=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,we=/-->/g,Ee=/>/g,E=RegExp(`>|${te}(?:([^\\s"'>=/]+)(${te}*=${te}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ae=/'/g,Se=/"/g,Me=/^(?:script|style|textarea|title)$/i,le=o=>(s,...e)=>({_$litType$:o,strings:s,values:e}),p=le(1),Te=le(2),vt=le(3),k=Symbol.for("lit-noChange"),l=Symbol.for("lit-nothing"),ke=new WeakMap,A=S.createTreeWalker(S,129);function Pe(o,s){if(!ce(o)||!o.hasOwnProperty("raw"))throw Error("invalid template strings array");return xe!==void 0?xe.createHTML(s):s}var Qe=(o,s)=>{let e=o.length-1,t=[],i,r=s===2?"<svg>":s===3?"<math>":"",n=U;for(let a=0;a<e;a++){let c=o[a],m,f,d=-1,h=0;for(;h<c.length&&(n.lastIndex=h,f=n.exec(c),f!==null);)h=n.lastIndex,n===U?f[1]==="!--"?n=we:f[1]!==void 0?n=Ee:f[2]!==void 0?(Me.test(f[2])&&(i=RegExp("</"+f[2],"g")),n=E):f[3]!==void 0&&(n=E):n===E?f[0]===">"?(n=i??U,d=-1):f[1]===void 0?d=-2:(d=n.lastIndex-f[2].length,m=f[1],n=f[3]===void 0?E:f[3]==='"'?Se:Ae):n===Se||n===Ae?n=E:n===we||n===Ee?n=U:(n=E,i=void 0);let _=n===E&&o[a+1].startsWith("/>")?" ":"";r+=n===U?c+Xe:d>=0?(t.push(m),c.slice(0,d)+Re+c.slice(d)+$+_):c+$+(d===-2?a:_)}return[Pe(o,r+(o[e]||"<?>")+(s===2?"</svg>":s===3?"</math>":"")),t]},I=class o{constructor({strings:s,_$litType$:e},t){let i;this.parts=[];let r=0,n=0,a=s.length-1,c=this.parts,[m,f]=Qe(s,e);if(this.el=o.createElement(m,t),A.currentNode=this.el.content,e===2||e===3){let d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(i=A.nextNode())!==null&&c.length<a;){if(i.nodeType===1){if(i.hasAttributes())for(let d of i.getAttributeNames())if(d.endsWith(Re)){let h=f[n++],_=i.getAttribute(d).split($),g=/([.?@])?(.*)/.exec(h);c.push({type:1,index:r,name:g[2],strings:_,ctor:g[1]==="."?ie:g[1]==="?"?oe:g[1]==="@"?re:T}),i.removeAttribute(d)}else d.startsWith($)&&(c.push({type:6,index:r}),i.removeAttribute(d));if(Me.test(i.tagName)){let d=i.textContent.split($),h=d.length-1;if(h>0){i.textContent=X?X.emptyScript:"";for(let _=0;_<h;_++)i.append(d[_],D()),A.nextNode(),c.push({type:2,index:++r});i.append(d[h],D())}}}else if(i.nodeType===8)if(i.data===Ce)c.push({type:2,index:r});else{let d=-1;for(;(d=i.data.indexOf($,d+1))!==-1;)c.push({type:7,index:r}),d+=$.length-1}r++}}static createElement(s,e){let t=S.createElement("template");return t.innerHTML=s,t}};function M(o,s,e=o,t){if(s===k)return s;let i=t!==void 0?e._$Co?.[t]:e._$Cl,r=z(s)?void 0:s._$litDirective$;return i?.constructor!==r&&(i?._$AO?.(!1),r===void 0?i=void 0:(i=new r(o),i._$AT(o,e,t)),t!==void 0?(e._$Co??=[])[t]=i:e._$Cl=i),i!==void 0&&(s=M(o,i._$AS(o,s.values),i,t)),s}var se=class{constructor(s,e){this._$AV=[],this._$AN=void 0,this._$AD=s,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(s){let{el:{content:e},parts:t}=this._$AD,i=(s?.creationScope??S).importNode(e,!0);A.currentNode=i;let r=A.nextNode(),n=0,a=0,c=t[0];for(;c!==void 0;){if(n===c.index){let m;c.type===2?m=new F(r,r.nextSibling,this,s):c.type===1?m=new c.ctor(r,c.name,c.strings,this,s):c.type===6&&(m=new ne(r,this,s)),this._$AV.push(m),c=t[++a]}n!==c?.index&&(r=A.nextNode(),n++)}return A.currentNode=S,i}p(s){let e=0;for(let t of this._$AV)t!==void 0&&(t.strings!==void 0?(t._$AI(s,t,e),e+=t.strings.length-2):t._$AI(s[e])),e++}},F=class o{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(s,e,t,i){this.type=2,this._$AH=l,this._$AN=void 0,this._$AA=s,this._$AB=e,this._$AM=t,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let s=this._$AA.parentNode,e=this._$AM;return e!==void 0&&s?.nodeType===11&&(s=e.parentNode),s}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(s,e=this){s=M(this,s,e),z(s)?s===l||s==null||s===""?(this._$AH!==l&&this._$AR(),this._$AH=l):s!==this._$AH&&s!==k&&this._(s):s._$litType$!==void 0?this.$(s):s.nodeType!==void 0?this.T(s):Ze(s)?this.k(s):this._(s)}O(s){return this._$AA.parentNode.insertBefore(s,this._$AB)}T(s){this._$AH!==s&&(this._$AR(),this._$AH=this.O(s))}_(s){this._$AH!==l&&z(this._$AH)?this._$AA.nextSibling.data=s:this.T(S.createTextNode(s)),this._$AH=s}$(s){let{values:e,_$litType$:t}=s,i=typeof t=="number"?this._$AC(s):(t.el===void 0&&(t.el=I.createElement(Pe(t.h,t.h[0]),this.options)),t);if(this._$AH?._$AD===i)this._$AH.p(e);else{let r=new se(i,this),n=r.u(this.options);r.p(e),this.T(n),this._$AH=r}}_$AC(s){let e=ke.get(s.strings);return e===void 0&&ke.set(s.strings,e=new I(s)),e}k(s){ce(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,t,i=0;for(let r of s)i===e.length?e.push(t=new o(this.O(D()),this.O(D()),this,this.options)):t=e[i],t._$AI(r),i++;i<e.length&&(this._$AR(t&&t._$AB.nextSibling,i),e.length=i)}_$AR(s=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);s!==this._$AB;){let t=$e(s).nextSibling;$e(s).remove(),s=t}}setConnected(s){this._$AM===void 0&&(this._$Cv=s,this._$AP?.(s))}},T=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(s,e,t,i,r){this.type=1,this._$AH=l,this._$AN=void 0,this.element=s,this.name=e,this._$AM=i,this.options=r,t.length>2||t[0]!==""||t[1]!==""?(this._$AH=Array(t.length-1).fill(new String),this.strings=t):this._$AH=l}_$AI(s,e=this,t,i){let r=this.strings,n=!1;if(r===void 0)s=M(this,s,e,0),n=!z(s)||s!==this._$AH&&s!==k,n&&(this._$AH=s);else{let a=s,c,m;for(s=r[0],c=0;c<r.length-1;c++)m=M(this,a[t+c],e,c),m===k&&(m=this._$AH[c]),n||=!z(m)||m!==this._$AH[c],m===l?s=l:s!==l&&(s+=(m??"")+r[c+1]),this._$AH[c]=m}n&&!i&&this.j(s)}j(s){s===l?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,s??"")}},ie=class extends T{constructor(){super(...arguments),this.type=3}j(s){this.element[this.name]=s===l?void 0:s}},oe=class extends T{constructor(){super(...arguments),this.type=4}j(s){this.element.toggleAttribute(this.name,!!s&&s!==l)}},re=class extends T{constructor(s,e,t,i,r){super(s,e,t,i,r),this.type=5}_$AI(s,e=this){if((s=M(this,s,e,0)??l)===k)return;let t=this._$AH,i=s===l&&t!==l||s.capture!==t.capture||s.once!==t.once||s.passive!==t.passive,r=s!==l&&(t===l||i);i&&this.element.removeEventListener(this.name,this,t),r&&this.element.addEventListener(this.name,this,s),this._$AH=s}handleEvent(s){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,s):this._$AH.handleEvent(s)}},ne=class{constructor(s,e,t){this.element=s,this.type=6,this._$AN=void 0,this._$AM=e,this.options=t}get _$AU(){return this._$AM._$AU}_$AI(s){M(this,s)}};var Ye=ae.litHtmlPolyfillSupport;Ye?.(I,F),(ae.litHtmlVersions??=[]).push("3.3.3");var Oe=(o,s,e)=>{let t=e?.renderBefore??s,i=t._$litPart$;if(i===void 0){let r=e?.renderBefore??null;t._$litPart$=i=new F(s.insertBefore(D(),r),r,void 0,e??{})}return i._$AI(o),i};var de=globalThis,v=class extends b{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let s=super.createRenderRoot();return this.renderOptions.renderBefore??=s.firstChild,s}update(s){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(s),this._$Do=Oe(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return k}};v._$litElement$=!0,v.finalized=!0,de.litElementHydrateSupport?.({LitElement:v});var et=de.litElementPolyfillSupport;et?.({LitElement:v});(de.litElementVersions??=[]).push("4.2.2");var Z=o=>(s,e)=>{e!==void 0?e.addInitializer(()=>{customElements.define(o,s)}):customElements.define(o,s)};var tt={attribute:!0,type:String,converter:L,reflect:!1,hasChanged:J},st=(o=tt,s,e)=>{let{kind:t,metadata:i}=e,r=globalThis.litPropertyMetadata.get(i);if(r===void 0&&globalThis.litPropertyMetadata.set(i,r=new Map),t==="setter"&&((o=Object.create(o)).wrapped=!0),r.set(e.name,o),t==="accessor"){let{name:n}=e;return{set(a){let c=s.get.call(this);s.set.call(this,a),this.requestUpdate(n,c,o,!0,a)},init(a){return a!==void 0&&this.C(n,void 0,o,a),a}}}if(t==="setter"){let{name:n}=e;return function(a){let c=this[n];s.call(this,a),this.requestUpdate(n,c,o,!0,a)}}throw Error("Unsupported decorator location: "+t)};function P(o){return(s,e)=>typeof e=="object"?st(o,s,e):((t,i,r)=>{let n=i.hasOwnProperty(r);return i.constructor.createProperty(r,t),n?Object.getOwnPropertyDescriptor(i,r):void 0})(o,s,e)}function q(o){return P({...o,state:!0,attribute:!1})}var he=o=>Math.max(0,Math.min(75,o));function He(o){let s=he(o.upper.angle??0),e=he(o.lower.angle??0),t=`rotate(${s} 150 70)`,i=`rotate(${-e} 150 70)`,r=n=>n.angle===void 0?"":`${n.label?`${n.label} `:""}${Math.round(he(n.angle))}\xB0`;return Te`
    <svg
  ...
  `,y([P({attribute:!1})],C.prototype,"hass",2),y([q()],C.prototype,"_config",2),C=y([Z("adjustable-bed-card-editor")],C);var x=class extends v{constructor(){super(...arguments);this._watched=[]}static async getConfigElement(){return document.createElement("adjustable-bed-card-editor")}static getStubConfig(e){return{type:"custom:adjustable-bed-card",device_id:e?Object.values(e.entities).find(i=>i.platform===ge)?.device_id:void 0}}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config=e}getCardSize(){return 8}shouldUpdate(e){if(e.has("_config")||!e.has("hass")||!this.hass)return!0;let t=e.get("hass");if(!t||t.entities!==this.hass.entities||t.devices!==this.hass.devices)return!0;for(let i of this._watched)if(t.states[i]!==this.hass.states[i])return!0;return!1}render(){if(!this.hass||!this._config)return l;if(!this._config.device_id)return this._notice("card.no_device");let e=Ne(this.hass,this._config.device_id),t=me(this.hass,e);if(e&&t.length)return this._renderPaired(e,t);let i=H(this.hass,this._config.device_id);return this._watched=this._collectWatched(i),K(i)?this._notice("card.no_entities"):p`
      <ha-card>
        ${this._header(i)}
        ${this._renderSections(i)}
      </ha-card>
    `}_renderSections(e){let t=this._config,i={graphic:()=>t.show_graphic!==!1?this._graphic(e):l,motors:()=>t.show_motors!==!1?this._motors(e):l,firmness:()=>t.show_firmness!==!1?this._firmness(e):l,presets:()=>t.show_presets!==!1?this._presets(e):l,memory:()=>t.show_memory!==!1?this._memory(e):l,lighting:()=>t.show_lighting!==!1?this._lighting(e):l,massage:()=>t.show_massage!==!1?this._massage(e):l,climate:()=>t.show_climate!==!1?this._climate(e):l,connection:()=>t.show_connection!==!1?this._connection(e):l};return this._orderedSections().map(r=>i[r]?.()??l)}_renderPaired(e,t){let i=this.hass,r=H(i,e),n=t.map(c=>({label:this._deviceLabel(c),bed:H(i,c)}));if(this._watched=[r,...n.map(c=>c.bed)].flatMap(c=>this._collectWatched(c)),K(r)&&n.every(c=>K(c.bed)))return this._notice("card.no_entities");let a=(c,m)=>K(m)?l:p`
            <div class="side">
      ...
      <ha-card>
        ${this._header(r)}
        ${a(u(this.hass,"card.both_sides"),r)}
        ${n.map(c=>a(c.label,c.bed))}
      </ha-card>
    `}_deviceLabel(e){let t=this.hass?.devices[e];return t?.name_by_user??t?.name??e}_orderedSections(){let e=this._config?.section_order;if(!e?.length)return[...O];let t=new Set(O),i=e.filter(n=>t.has(n)),r=O.filter(n=>!i.includes(n));return[...i,...r]}_header(e){let t=e.connectivity?this._state(e.connectivity)?.state==="on":void 0;return p`
      <div class="header">
    ...
    `}_memory(e){let t=e.memory,i=this._config?.memory_slots;if(i&&i.length){let c=new Set(i.map(Number));t=t.filter(m=>c.has(m.slot))}if(t.length===0)return l;let r=this._config?.memory_save!==!1&&t.some(c=>c.save),n=t.map(c=>c.save??c.goto??String(c.slot)).join("|"),a=this._saveModeFor===n;return p`
      ...
      ${a?p`<div class="hint">${u(this.hass,"memory.set_hint")}</div>`:l}
  ...
  `,y([P({attribute:!1})],x.prototype,"hass",2),y([q()],x.prototype,"_config",2),y([q()],x.prototype,"_saveModeFor",2),x=y([Z("adjustable-bed-card")],x);var ue=window;ue.customCards=ue.customCards||[];ue.customCards.push({type:"adjustable-bed-card",name:"Adjustable Bed Card",description:"Native control card for the Adjustable Bed integration.",preview:!0,documentationURL:"https://github.com/kristofferR/ha-adjustable-bed"});console.info(`%c adjustable-bed-card %c ${Ue} `,"color:white;background:#3f51b5;border-radius:3px 0 0 3px;padding:2px","color:#3f51b5;background:#e8eaf6;border-radius:0 3px 3px 0;padding:2px");export{x as AdjustableBedCard};
